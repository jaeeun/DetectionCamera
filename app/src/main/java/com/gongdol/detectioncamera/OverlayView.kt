...
package com.gongdol.detectioncamera.objectdetection
...
//            Log.i(TAG,"result type : "+r+", "+g+", "+b)
        ...
        // Draw text for detected Count
        val drawCount = "Detect Count : "+results.size.toString()+" / 5"
        textPaint.color = Color.GREEN
        canvas.drawText(drawCount, canvas.width-450f, 50.0f, textPaint)
